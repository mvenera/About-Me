 ...
 * can apply test design techniques such as boundary value analisys, equivalence paritioning, state transition, decision table, and use case to draw test cases
...
The final project consisted of choosing an application and start the testing process based on business specifications, from Test Planning until Test Completion.

The test plan, test cases, bugs, test results for the final project can be found here: [Final project](https://github.com/mvenera/manual_testing_project)
